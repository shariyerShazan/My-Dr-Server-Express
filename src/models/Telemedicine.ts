...
const TelemedicineSchema: Schema = new Schema(
  {
    ...
    status: { type: String, enum: Object.values(CallStatus), default: CallStatus.SCHEDULED },
    startedAt: { type: Date },
    endedAt: { type: Date }
  },
  { timestamps: true }
...
export const Telemedicine = mongoose.model<ITelemedicine>('Telemedicine', TelemedicineSchema);
